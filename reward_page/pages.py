...
class Reward(Page):
    ...
    def vars_for_template(self):
        ...
        diff_red_payoff = random.choice([2, 6, 8])
        diff_blue_payoff = random.choice([0, 6, 10])
        if diff_init_choice == '彩票C':
        ...
        # print(same_subj_responses_list)
        # print(same_subj_rand_values_list)
        # print(f"在第一部分的实验中，您的选择是{selected_response}, 它的值是{selected_rand_value}。")


class PageIfSubjectRefresh(Page):
    form_model = 'player'

page_sequence = [Reward, PageIfSubjectRefresh]
